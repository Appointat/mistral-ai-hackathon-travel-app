...
def learning_by_QA(
    ...
    # Therefore, the TASK is to create a set of detailed evaluation criteria to promote education in Deep Learning, by the similar method in the provied example.
    # """
    task_prompt = """
